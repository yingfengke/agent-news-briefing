...
6. 【强制中文】即使原文是英文，title 和 summary 必须输出中文，专有名词首次出现可括号注明英文原名。技术术语保留英文缩写，如「FlashAttention-3 将 ATT 层的 FLOPs 压到 O(n·d)」
...
7. 【强制中文】即使原文是英文，title 和 summary 必须输出中文。专有名词首次出现可括号注明英文原名。
...
4. 【强制中文】即使原文是英文，title 和 summary 必须输出中文，专有名词首次出现可括号注明英文原名。
5. 【来源分组规则】同标准配置
